...
//               <br />
//               Get expert support from <span className="font-semibold text-gray-800 italic">Glocal Accounting</span>
//               <br />
...
//                 <div>
//                   <label className="block text-xs text-black-1 mb-1">First Name</label>
//                   <input
//                     type="text"
...
//                 </div>
//                 <div>
//                   <label className="block text-xs text-black-1 mb-1">Last Name</label>
//                   <input
//                     type="text"
//                     className="w-full border-b border-rose-400 py-2 text-sm focus:outline-none  bg-transparent"
//                   />
...
//               <div className="grid grid-cols-2 gap-4 py-1">
//                 <div>
//                   <label className="block text-xs text-black-1 mb-1">Email</label>
//                   <input
//                     type="email"
//                     className="w-full border-b border-rose-400 py-2 text-sm focus:outline-none  bg-transparent"
//                   />
//                 </div>
//                 <div>
//                   <label className="block text-xs text-black-1 mb-1">Company</label>
//                   <input
//                     type="text"
//                     className="w-full border-b border-rose-400 py-2 text-sm focus:outline-none  bg-transparent"
//                   />
...
//               <div className="grid grid-cols-2 gap-4 py-1">
//                 <div>
//                   <label className="block text-xs text-black-1 mb-1">Job Title</label>
//                   <input
//                     type="text"
//                     className="w-full border-b border-rose-400 py-2 text-sm focus:outline-none  bg-transparent"
//                   />
//                 </div>
//                 <div>
//                   <label className="block text-xs text-black-1 mb-1">Phone</label>
//                   <input
//                     type="tel"
//                     className="w-full border-b border-rose-400 py-2 text-sm focus:outline-none  bg-transparent"
//                   />
...
//               <button
//                 type="submit"
//                 className="w-[85%] mx-auto bg-linear-to-r from-[#EC2F6B] to-[#315A68] text-white font-medium py-3 rounded-full transition-all flex items-center justify-center gap-2"
//               >
//                 <img src="/call-icon.png" alt="" className="w-5 h-5 object-contain" />
